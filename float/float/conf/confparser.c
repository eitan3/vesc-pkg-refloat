...
int32_t confparser_serialize_float_config(uint8_t *buffer, const float_config *conf) {
	...
	buffer_append_float16(buffer, conf->mahony_kp_roll, 100, &ind);
	buffer_append_float16(buffer, conf->mahony_kp_yaw, 100, &ind);
...
bool confparser_deserialize_float_config(const uint8_t *buffer, float_config *conf) {
	...
	conf->mahony_kp_roll = buffer_get_float16(buffer, 100, &ind);
	conf->mahony_kp_yaw = buffer_get_float16(buffer, 100, &ind);
...
void confparser_set_defaults_float_config(float_config *conf) {
	...
	conf->mahony_kp_roll = APPCONF_FLOAT_MAHONY_KP_ROLL;
	conf->mahony_kp_yaw = APPCONF_FLOAT_MAHONY_KP_YAW;
